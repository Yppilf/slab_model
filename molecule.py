...
class Molecule:
    def __init__(self, moleculeName, temperature, isotopes=[1]):
    ...
    def generateSlab(self, column_density, lower_wavelength, upper_wavelength):
        ...
        self.output_filename = f"models/slab_model_{self.molecule}_{self.temperature}K_{lower_wavelength}-{upper_wavelength}um_{column_density}cm-2.out"
        self.data = runs.run_0D_slab(Ng         = column_density,            # The gas column density in molecules per cm2
                                Tg         = self.temperature,          # The gas temperature
